    ...
    return (
        <View className='about'>
            <View className='content'>
                <View className='title'>关于X-Novel</View>
                ...
                <View className='tip'>目的</View>
                <View className='sku'>· 之前一直在做微信小程序，为了学习React，选择了小程序Taro框架。</View>
                <View className='line'></View>
                <View className='tip'>运行</View>
                <View className='sku'>· git clone https://github.com/Jerry-1123/X-Novel.git</View>
                <View className='sku'>· cd X-Novel</View>
